...
test("Traditional Chinese and Japanese core interface copy does not fall back to English",async()=>{
  ...
  const [home,layout]=await Promise.all([read("lib/home-interface-translations.generated.ts"),read("app/[lang]/layout.tsx")]);
  ...
  assert.match(layout,/大愛元宇宙 — AI、RWA 與全球社群/);
  assert.match(layout,/`%s \| \$\{brand\}`/);
