...
test("footer and pricing publish one GreatLoveMeta-local plan source", async () => {
  ...
  for (const marker of ["fallbackAmountCents: 500", "fallbackAmountCents: 800", "7 天免费试用", "内置私密小组音视频与沟通中心", "公开网络研讨会与 HLS 广播", "DeepSeek V4 Flash 默认，可选 OpenAI"]) assert.match(plans, new RegExp(marker));
