-- Waiting playlists now play locally in each visitor's browser in every mode.
-- No playlist item opens RealtimeKit or HLS; human media still uses the saved mode.
UPDATE class_rooms
SET description = 'Permanent public demo with a client-local waiting playlist and real open media. Credits: /demo-media-attribution.txt',
    subject = 'Local waiting-playlist demo',
...
INSERT OR REPLACE INTO class_playlist_items
