...
CREATE INDEX `platform_admin_audit_target_idx` ON `platform_admin_audit` (`target_user_id`,`created_at`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `platform_member_access_status_idx` ON `platform_member_access` (`status`,`updated_at`);