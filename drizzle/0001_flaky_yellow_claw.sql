...
CREATE INDEX `greatlovemeta_referrals_code_idx` ON `referrals` (`referral_code_id`);--> statement-breakpoint
CREATE INDEX `greatlovemeta_referrals_status_idx` ON `referrals` (`status`);--> statement-breakpoint
...
CREATE INDEX `greatlovemeta_reward_user_idx` ON `reward_ledger` (`user_id`);--> statement-breakpoint
...
CREATE INDEX `greatlovemeta_subscriptions_status_idx` ON `subscriptions` (`status`);