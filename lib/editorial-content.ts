...
export const fallbackNews: EditorialDocument = {
  ...
  zh: [
    { label: "平台 · 身份", date: "2026-07-22", title: "统一数字公民档案进入建设阶段", body: "首个账号身份层将连接个人档案、社区参与、私信、实时聊天、项目与未来数字凭证。" },
...
export const fallbackEvents: EditorialDocument = {
  ...
  zh: [
    { label: "社区说明会", status: "即将开放", location: "线上 · 中英双语", date: "2026", title: "认识全球数字公民社区", body: "通过引导了解公民档案、社区频道、私信、实时聊天与项目参与方式。" },
