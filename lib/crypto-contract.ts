...
export type CryptoPaymentSetting = {
  ...
  smartPay3Contract:string|null;smartPay3UsdtPercent:number;monthlyAmountCents:number;annualAmountCents:number;monthlyTokenAmount:string;annualTokenAmount:string;minConfirmations:number;walletConnectProjectId:string|null;enabled:number;
};
