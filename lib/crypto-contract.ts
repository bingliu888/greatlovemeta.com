...
export type CryptoPaymentSetting = {
  ...
  smartPay5Contract:string|null;smartPay5UsdtPercent:number;monthlyAmountCents:number;annualAmountCents:number;monthlyTokenAmount:string;annualTokenAmount:string;minConfirmations:number;walletConnectProjectId:string|null;enabled:number;
};
