...
import { projectBuilds, projectReports, projectStats, type ProjectBuild } from "./project-status";

export type RuntimeProjectReport = (typeof projectReports)[number];
