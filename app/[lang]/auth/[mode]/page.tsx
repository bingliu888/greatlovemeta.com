...
const pageCopy = {
  ...
  zh: { title: "登录或加入", description: "输入邮箱获取一次性验证码。首次验证成功后，系统将自动创建大爱元宇宙账号。", quote: "伟大的社区，成长于参与、信任与共同进步。", back: "返回首页" },
} as const;
